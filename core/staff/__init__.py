...
from .schema import CreateStaffSchema, UpdateStaffSchema
...
@staff.route('/staff/list', methods=['GET'])
@validate_token
...
@staff.route('/staff/<staff_id>', methods=['GET'])
@validate_token
...
@staff.route('/staff/<staff_id>', methods=['DELETE'])
@validate_token
...
@staff.route('/staff/<staff_id>', methods=['PUT'])
@validate_token
